        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="input-group">
                    ...
                    <a href="{{ route('add_student') }}" class="btn btn-success text-white" data-toggle="tooltip" title="{{__a('create_student')}}"><i class="la la-plus-circle"></i> {{ __a('create_student') }}</a>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($users as $u)
                            <tr>
                                ...
                                <td><a href="{{ route('edit_student',$u->id) }}" ><i class="la la-edit text-info la-1x"></i></a></td>
