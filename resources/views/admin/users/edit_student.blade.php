        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <label><input type="radio" name="gender" value="1" checked="( {{ $student->gender }} === 'male'?'checked':'' )"> {{__a('male')}}</label> <br />
                        <label><input type="radio" name="gender" value="0" checked="( {{ $student->gender }} === 'female'?'checked':'' )"> {{__a('female')}}</label>
                    </div>
                </div>
