        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group row {{ $errors->has('password_confirmation')? 'has-error':'' }} ">
                    ...
                    <div class="col-sm-7">
                        <input type="password" name="password_confirmation" value="" placeholder="@lang('admin.password_confirmation')" id="confirm_password" class="form-control">
                ...
                <div class="form-group row {{ $errors->has('user_type')? 'has-error':'' }} ">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="user_type" value="instructor" placeholder="@lang('admin.user_type')" id="confirm_password" class="form-control" readonly>
